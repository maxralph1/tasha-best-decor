const passwordlessSignInMailTemplate = (userFound) => {
    return `
        ...
        <p>Click on the following <a href="${process.env.CLIENT_URL}/passwordless-signin/${userFound?.username}/${userFound?.email_verify_token}">link</a> to sign into your account.</p>
