...
import productSpecificationRouter from './apiRoutes/productSpecificationRoutes.js'; 
import productSpecificationValueRouter from './apiRoutes/productSpecificationValueRoutes.js'; 
import productUnitRouter from './apiRoutes/productUnitRoutes.js';
...
router.use('/product-specification-values', productSpecificationValueRouter); 
router.use('/product-units', productUnitRouter); 
